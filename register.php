                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form  action="process2.php" method="post" enctype="multipart/form-data">
                                ...
                                <input type="file" name="image" placeholder="Upload Image"  accept= "image/jpg, image/png, image/jpeg" class="form-control mb-3" >
                                <input type="checkbox" name="checkbox"  class=" form-check-input mb-0" required>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text-decoration-none text-dark" href="termsandconditions.php">Agree to our Terms and Conditions</a>
